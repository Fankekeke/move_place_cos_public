...
public class PriceRulesServiceImpl extends ServiceImpl<PriceRulesMapper, PriceRules> implements IPriceRulesService {
     ...
     */
    @Override
    public IPage<LinkedHashMap<String, Object>> queryPriceRulesPage(Page<PriceRules> page, PriceRules priceRules) {
        return baseMapper.queryPriceRulesPage(page, priceRules);
    }
}
